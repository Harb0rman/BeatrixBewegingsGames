class ConnectFour {
    ...
    updateShadowPiece() {
        ...
        if (dropRow >= 0) {
            ...
            this.shadowPiece.style.transform = `translate(${rect.left - boardRect.left}px, ${rect.top - boardRect.top}px)`;
        } else {
            this.shadowPiece.style.display = 'none'; // Hide the shadow piece if no valid cell is found
        }
    }
